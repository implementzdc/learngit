    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="javascript:;" target="_blank" class="logo">
                ...
                <span class="logo-lg">深圳市协勤实业有限公司<strong>电子元器件供应链管理平台</strong></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li class="divider"></li>
                                <li><a href="/loginout.do"><i class="ace-icon fa fa-power-off"></i>安全退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div id="content-wrapper" class="content-wrapper">
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    ...
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="welcome.html" frameborder="0" data-id="default.html"></iframe>
                </div>
            </div>
        </div>
    </div>
